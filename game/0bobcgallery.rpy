default persistent.gallery_unlocked = True
...
define BOBCGALLERY_VARIANT_ICON = True
...
define BOBCGALLERY_VARIANT_ICON_XSIZE = 50
define BOBCGALLERY_VARIANT_ICON_YSIZE = 30

image bobcgallery_locked_cg = Transform("#aaa", xysize=(BOBCGALLERY_THUMB_XMAXIMUM, BOBCGALLERY_THUMB_YMAXIMUM))
image bobcgallery_variant_i = Composite(
    (BOBCGALLERY_VARIANT_ICON_XSIZE, BOBCGALLERY_VARIANT_ICON_YSIZE),
    (0, 0), Fixed("#000", xysize=(BOBCGALLERY_VARIANT_ICON_XSIZE-5,BOBCGALLERY_VARIANT_ICON_YSIZE-5)),
    (2, 2), Fixed("#fff", xysize=(BOBCGALLERY_VARIANT_ICON_XSIZE-9,BOBCGALLERY_VARIANT_ICON_YSIZE-9))
    )
image bobcgallery_variant_icon = Fixed(
    Composite((BOBCGALLERY_VARIANT_ICON_XSIZE,BOBCGALLERY_VARIANT_ICON_YSIZE), (0, 0), "bobcgallery_variant_i", (5, 5), "bobcgallery_variant_i"),
    xysize=(BOBCGALLERY_VARIANT_ICON_XSIZE, BOBCGALLERY_VARIANT_ICON_YSIZE))
