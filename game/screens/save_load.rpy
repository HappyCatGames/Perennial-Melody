...
define config.thumbnail_height = 170
    ...
    fixed:
        ...
        vbox:
            ...
            hbox:
                ...
                textbutton _("<") action FilePagePrevious() hovered Play('sound', randomizeAudio())

                if config.has_autosave:
                    textbutton _("{#auto_page}A") action FilePage("auto") hovered Play('sound', randomizeAudio())

                if config.has_quicksave:
                    textbutton _("{#quick_page}Q") action FilePage("quick") hovered Play('sound', randomizeAudio())
