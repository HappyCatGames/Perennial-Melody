...
screen confirm(message, yes_action, no_action=None):
    ...
    add "gui/overlay/confirm.png" # You can replace this with your own overlay image
...
style confirm_frame:
    background Frame(["gui/confirm_frame.png", "gui/frame.png"], 60, 100, 60, 60, tile=False)
...
style notify_frame:
    ...
    background Frame("gui/skip.png", 24, 8, 60, 8, tile=False)
    padding (24, 8, 60, 8)
